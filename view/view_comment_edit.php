...
<head>
    <meta charset="utf-8">
    <title>Stuck Overflow - Edit comment</title>
    <base href="<?= $web_root ?>"/>
        ...
        <div class="show">
            <div class ="question_cadre">
                ...
                <div class="add_edit_comments">
                    ...
                    <form action = "comment/edit/<?=$comment->Id ?>" name="comment_add" id="edit_com" method = "post">
                        <textarea id="comment" name="markdown_body" rows=5 cols=100 required><?=$comment->Body ?></textarea> <br>
